...
public class MemberController {
	...
	public Object insert(Member member, HttpSession session) throws Exception {
	...
	@RequestMapping("/list")
	public Object list(@RequestParam(required = false, defaultValue = "1") int pageNo,
	...
	@RequestMapping("/fbGetUser")
	public Object fbGetUser(String userId) {
		return memberService.fbGetUser(userId);
	}

	@RequestMapping("/fbExist")
	public Object fbExist(String userId) {

		Map<String, Object> result = new HashMap<String, Object>();
		if (memberService.fbExist(userId) > 0) {
			result.put("data", "yes");
		} else {
			result.put("data", "no");
		}
