...
public class CompanyController {
  ...
  public Object pubTrans(
		  @RequestParam(required=false, defaultValue="127.11040408554267")
		  String sX,
		  @RequestParam(required=false, defaultValue="37.509756362942284")
		  String sY,
		  @RequestParam(required=false, defaultValue="127.13806175828525")
		  String eX,
		  @RequestParam(required=false, defaultValue="37.48078441518208")
		  String eY) {
